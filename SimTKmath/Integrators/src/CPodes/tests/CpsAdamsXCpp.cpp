...
class Problem1System : public SimTK::CPodesSystem {
    ...
    int implicitODE(Real t, const Vector& y, const Vector& yp, Vector& fout) const override;
};
...
int Problem1System::implicitODE(Real t, const Vector& y, const Vector& yp, Vector& res) const {
...
int Problem2System::implicitODE(Real t, const Vector& y, const Vector& yp, Vector& res) const {
