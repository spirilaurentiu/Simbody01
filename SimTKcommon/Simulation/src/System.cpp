...
bool System::isEmptyHandle() const {
    return guts == 0;
}
bool System::isOwnerHandle() const {
    return guts == 0 || &guts->getSystem() == this;
}
...
void System::adoptSystemGuts(System::Guts* g) {
    ...
    SimTK_ASSERT_ALWAYS(!guts, "System::adoptSystemGuts(): this System handle is already in use");
    guts = g;
    guts->setOwnerHandle(*this);
}

const String& System::getName() const {
    return getSystemGuts().getName();
}
const String& System::getVersion() const {
    return getSystemGuts().getVersion();
}

System& System::setDefaultTimeScale(Real tc) {
    updSystemGuts().updRep().setDefaultTimeScale(tc);
    return *this;
}
...
System& System::setDefaultLengthScale(Real lc) {
    updSystemGuts().updRep().setDefaultLengthScale(lc);
    return *this;
}
...
System& System::setUpDirection(const CoordinateDirection& up) {
    updSystemGuts().updRep().setUpDirection(up);
    return *this;
}
...
void System::resetAllCountersToZero() {
    updSystemGuts().updRep().resetAllCounters();
}
int System::getNumRealizationsOfThisStage(Stage g) const {
    return getSystemGuts().getRep().nRealizationsOfStage[g];
}
int System::getNumRealizeCalls() const {
    return getSystemGuts().getRep().nRealizeCalls;
}

int System::getNumPrescribeQCalls() const {
    return getSystemGuts().getRep().nPrescribeQCalls;
}
int System::getNumPrescribeUCalls() const {
    return getSystemGuts().getRep().nPrescribeUCalls;
}

int System::getNumProjectQCalls() const {
    return getSystemGuts().getRep().nProjectQCalls;
}
int System::getNumProjectUCalls() const {
    return getSystemGuts().getRep().nProjectUCalls;
}
int System::getNumFailedProjectQCalls() const {
    return getSystemGuts().getRep().nFailedProjectQCalls;
}
int System::getNumFailedProjectUCalls() const {
    return getSystemGuts().getRep().nFailedProjectUCalls;
}
int System::getNumQProjections() const {
    return getSystemGuts().getRep().nQProjections;
}
int System::getNumUProjections() const {
    return getSystemGuts().getRep().nUProjections;
}
int System::getNumQErrorEstimateProjections() const {
    return getSystemGuts().getRep().nQErrEstProjections;
}
int System::getNumUErrorEstimateProjections() const {
    return getSystemGuts().getRep().nUErrEstProjections;
}

int System::getNumHandlerCallsThatChangedStage(Stage g) const {
    return getSystemGuts().getRep().nHandlerCallsThatChangedStage[g];
}
int System::getNumHandleEventCalls() const {
    return getSystemGuts().getRep().nHandleEventsCalls;
}
int System::getNumReportEventCalls() const {
    return getSystemGuts().getRep().nReportEventsCalls;
}
...
State& System::updDefaultState() {
    return updSystemGuts().updDefaultState();
}
...
/*! <!-- Stage info --> */
const void System::PrintStages() const {
    return getSystemGuts().PrintStages();
} // FIXTORROLL
const void System::PrintDefaultStateStages() const {
    return getSystemGuts().PrintDefaultStateStages();
} // FIXTORROLL
const void System::PrintSubsystemsStages() const {
    return getSystemGuts().PrintSubsystemsStages();
} // FIXTORROLL
...
void System::calcDecorativeGeometryAndAppend(const State& s,
                                             Stage g,
...
void System::handleEvents(State& s,
                          Event::Cause cause,
...
void System::calcTimeOfNextScheduledEvent(const State& s,
                                          Real& tNextEvent,
...
void System::calcTimeOfNextScheduledReport(const State& s,
                                           Real& tNextEvent,
                                           Array_<EventId>& eventIds,
                                           bool includeCurrentTime) const {
...
// Copy constructor
System::Guts::Guts(const Guts& src)
    : rep(0) {
    if (src.rep) {
...
const String& System::Guts::getName() const {
    return getRep().getName();
}
const String& System::Guts::getVersion() const {
    return getRep().getVersion();
}
...
void System::Guts::invalidateSystemTopologyCache() const {
    return getRep().invalidateSystemTopologyCache();
} // mutable
...
State& System::Guts::updDefaultState() {
    SimTK_STAGECHECK_TOPOLOGY_REALIZED_ALWAYS(systemTopologyHasBeenRealized(),
                                              "System",
                                              getName(),
                                              "System::Guts::updDefaultState()");

    return updRep().updDefaultState();
}

int System::Guts::getNumSubsystems() const {
    return getRep().getNumSubsystems();
}
...
/*! <!-- Stage info --> */
const void System::Guts::PrintDefaultStateStages() const {
...
/*! <!-- Stage info --> */
const void System::Guts::PrintSubsystemsStages() const {
    if (!systemTopologyHasBeenRealized()) {
        std::cout << " System topology has NOT been realized yet." << std::endl << std::flush;
        return;
    }
    ...
    for (SubsystemIndex i(0); i < getNumSubsystems(); ++i) {
        ...
        std::cout << " " << getRep().subsystems[i].getVersion() << " "
...
const State& System::Guts::realizeTopology() const {
    ...
    for (SubsystemIndex i(0); i < getNumSubsystems(); ++i) {
        defaultState.initializeSubsystem(i,
                                         getRep().subsystems[i].getName(),
    ...
    defaultState.setSystemTopologyStageVersion(getRep().getSystemTopologyCacheVersion());
...
void System::Guts::realizeModel(State& s) const {
    ...
    SimTK_STAGECHECK_GE_ALWAYS(s.getSystemStage(), Stage::Topology, "System::Guts::realizeModel()");
    SimTK_STAGECHECK_TOPOLOGY_VERSION_ALWAYS(getSystemTopologyCacheVersion(),
                                             s.getSystemTopologyStageVersion(),
                                             "System",
                                             getName(),
                                             "System::Guts::realizeModel()");
...
void System::Guts::realizeTime(const State& s) const {
    SimTK_STAGECHECK_GE_ALWAYS(s.getSystemStage(), Stage(Stage::Time).prev(), "System::Guts::realizeTime()");
...
void System::Guts::multiplyByN(const State& s, const Vector& u, Vector& dq) const {
    SimTK_STAGECHECK_GE(s.getSystemStage(), Stage::Position, "System::Guts::multiplyByN()");
    return multiplyByNImpl(s, u, dq);
}
void System::Guts::multiplyByNTranspose(const State& s, const Vector& fq, Vector& fu) const {
    SimTK_STAGECHECK_GE(s.getSystemStage(), Stage::Position, "System::Guts::multiplyByNTranspose()");
    return multiplyByNTransposeImpl(s, fq, fu);
}
void System::Guts::multiplyByNPInv(const State& s, const Vector& dq, Vector& u) const {
    SimTK_STAGECHECK_GE(s.getSystemStage(), Stage::Position, "System::Guts::multiplyByNPInv()");
    return multiplyByNPInvImpl(s, dq, u);
}
void System::Guts::multiplyByNPInvTranspose(const State& s, const Vector& fu, Vector& fq) const {
    SimTK_STAGECHECK_GE(s.getSystemStage(), Stage::Position, "System::Guts::multiplyByNPInvTranspose()");
...
bool System::Guts::prescribeQ(State& s) const {
    SimTK_STAGECHECK_GE_ALWAYS(s.getSystemStage(), Stage::Time, "System::Guts::prescribeQ()");
...
bool System::Guts::prescribeU(State& s) const {
    SimTK_STAGECHECK_GE_ALWAYS(s.getSystemStage(), Stage::Position, "System::Guts::prescribeU()");
...
//                          GET FREE Q(U) INDEX
//------------------------------------------------------------------------------
void System::Guts::getFreeQIndex(const State& s, Array_<SystemQIndex>& freeQs) const {
    SimTK_STAGECHECK_GE_ALWAYS(s.getSystemStage(), Stage::Instance, "System::Guts::getFreeQIndex()");
    return getFreeQIndexImpl(s, freeQs);
}
void System::Guts::getFreeUIndex(const State& s, Array_<SystemUIndex>& freeUs) const {
    SimTK_STAGECHECK_GE_ALWAYS(s.getSystemStage(), Stage::Instance, "System::Guts::getFreeUIndex()");
...
//                                PROJECT Q
//------------------------------------------------------------------------------
void System::Guts::projectQ(State& s,
                            Vector& qErrEst,
                            const ProjectOptions& options,
                            ProjectResults& results) const {
    SimTK_STAGECHECK_GE_ALWAYS(s.getSystemStage(), Stage::Position, "System::Guts::projectQ()");
...
//                                PROJECT U
//------------------------------------------------------------------------------
void System::Guts::projectU(State& s,
                            Vector& uErrEst,
                            const ProjectOptions& options,
                            ProjectResults& results) const {
    SimTK_STAGECHECK_GE_ALWAYS(s.getSystemStage(), Stage::Velocity, "System::Guts::projectU()");
    const System::Guts::GutsRep& rep = getRep();
...
//                             HANDLE EVENTS
//------------------------------------------------------------------------------
void System::Guts::handleEvents(State& s,
                                Event::Cause cause,
                                const Array_<EventId>& eventIds,
                                const HandleEventsOptions& options,
                                HandleEventsResults& results) const {
    // TODO: is Model the right stage?
    SimTK_STAGECHECK_GE_ALWAYS(s.getSystemStage(), Stage::Model, "System::Guts::handleEvents()");
...
//                              REPORT EVENTS
//------------------------------------------------------------------------------
void System::Guts::reportEvents(const State& s, Event::Cause cause, const Array_<EventId>& eventIds) const {
    // TODO: is Model this the right stage?
    SimTK_STAGECHECK_GE_ALWAYS(s.getSystemStage(), Stage::Model, "System::Guts::reportEvents()");
...
//------------------------------------------------------------------------------
void System::Guts::calcTimeOfNextScheduledEvent(const State& s,
                                                Real& tNextEvent,
                                                Array_<EventId>& eventIds,
                                                bool includeCurrentTime) const {
    SimTK_STAGECHECK_GE_ALWAYS(s.getSystemStage(),
...
//------------------------------------------------------------------------------
void System::Guts::calcTimeOfNextScheduledReport(const State& s,
                                                 Real& tNextEvent,
                                                 Array_<EventId>& eventIds,
                                                 bool includeCurrentTime) const {
    SimTK_STAGECHECK_GE_ALWAYS(s.getSystemStage(),
...
void System::Guts::calcEventTriggerInfo(const State& s, Array_<EventTriggerInfo>& info) const {
    SimTK_STAGECHECK_GE_ALWAYS(s.getSystemStage(), Stage::Instance, "System::Guts::calcEventTriggerInfo()");
...
void System::Guts::realize(const State& s, Stage g) const {
    SimTK_STAGECHECK_GE_ALWAYS(s.getSystemStage(), Stage::Model, "System::Guts::realize()");
    ...
    while ((stageNow = s.getSystemStage()) < g) {
        switch (stageNow) {
            ...
            case Stage::Acceleration:
                ...
                break;
            default:
                assert(!"System::Guts::realize(): bad stage");
        }
    }
}
...
//------------------------------------------------------------------------------
void System::Guts::calcDecorativeGeometryAndAppend(const State& s,
                                                   Stage stage,
                                                   Array_<DecorativeGeometry>& geom) const {
...
void System::Guts::multiplyByNImpl(const State& state, const Vector& u, Vector& dq) const {
    SimTK_THROW2(Exception::UnimplementedVirtualMethod, "System::Guts", "multiplyByNImpl");
}
void System::Guts::multiplyByNTransposeImpl(const State& state, const Vector& fq, Vector& fu) const {
    SimTK_THROW2(Exception::UnimplementedVirtualMethod, "System::Guts", "multiplyByNTransposeImpl");
}
void System::Guts::multiplyByNPInvImpl(const State& state, const Vector& dq, Vector& u) const {
    SimTK_THROW2(Exception::UnimplementedVirtualMethod, "System::Guts", "multiplyByNPInvImpl");
}
void System::Guts::multiplyByNPInvTransposeImpl(const State& state, const Vector& fu, Vector& fq) const {
    SimTK_THROW2(Exception::UnimplementedVirtualMethod, "System::Guts", "multiplyByNPInvTransposeImpl");
}
...
// SubsystemIndex.
void System::Guts::handleEventsImpl(State& state,
                                    Event::Cause cause,
                                    const Array_<EventId>& eventIds,
                                    const HandleEventsOptions& options,
                                    HandleEventsResults& results) const {
    ...
    for (SubsystemIndex sx(0); sx < getNumSubsystems(); ++sx) {
        ...
        if (!eventIds.empty()) {
            getSystem().getDefaultSubsystem().findSubsystemEventIds(sub.getMySubsystemIndex(),
                                                                    state,
                                                                    eventIds,
                                                                    eventsForSubsystem);
...
// SubsystemIndex.
int System::Guts::reportEventsImpl(const State& s,
                                   Event::Cause cause,
...
//------------------------------------------------------------------------------
// This is the default implementation but shouldn't need to be overridden.
int System::Guts::calcTimeOfNextScheduledEventImpl(const State& s,
                                                   Real& tNextEvent,
                                                   Array_<EventId>& eventIds,
                                                   bool includeCurrentTime) const {
    tNextEvent = Infinity;
...
//------------------------------------------------------------------------------
// This is the default implementation but shouldn't need to be overridden.
int System::Guts::calcTimeOfNextScheduledReportImpl(const State& s,
                                                    Real& tNextEvent,
                                                    Array_<EventId>& eventIds,
                                                    bool includeCurrentTime) const {
    tNextEvent = Infinity;
...
class DefaultSystemSubsystem::Guts : public Subsystem::Guts {
    public:
    Guts()
        : Subsystem::Guts("DefaultSystemSubsystem", "0.0.1") {
    }
    ...
    CachedEventInfo& updCachedEventInfo(const State& s) const {
        return Value<CachedEventInfo>::updDowncast(updCacheEntry(s, cachedEventInfoIndex)).upd();
    }

    int realizeSubsystemTopologyImpl(State& s) const override {
        cachedEventInfoIndex =
            s.allocateCacheEntry(getMySubsystemIndex(), Stage::Topology, new Value<CachedEventInfo>());
        ...
        for (Array_<ScheduledEventHandler*>::const_iterator e = scheduledEventHandlers.begin();
             e != scheduledEventHandlers.end();
             ++e) {
            EventId id;
            createScheduledEvent(s, id);
            info.scheduledEventIds.push_back(id);
        }
        for (Array_<TriggeredEventHandler*>::const_iterator e = triggeredEventHandlers.begin();
             e != triggeredEventHandlers.end();
             ++e) {
            EventId id;
        ...
        for (Array_<ScheduledEventReporter*>::const_iterator e = scheduledEventReporters.begin();
             e != scheduledEventReporters.end();
             ++e) {
            EventId id;
            createScheduledEvent(s, id);
            info.scheduledReportIds.push_back(id);
        }
        for (Array_<TriggeredEventReporter*>::const_iterator e = triggeredEventReporters.begin();
             e != triggeredEventReporters.end();
             ++e) {
            EventId id;
            EventTriggerByStageIndex index;
            createTriggeredEvent(s, id, index, (*e)->getRequiredStage());
    ...
    void calcEventTriggerInfoImpl(const State& s, Array_<EventTriggerInfo>& trigInfo) const override {
        ...
        for (int i = 0; i < (int)triggeredEventHandlers.size(); ++i) {
            ...
            const SystemEventTriggerIndex index(
                info.triggeredEventIndices[i] + s.getEventTriggerStartByStage(stage)
        ...
        for (int i = 0; i < (int)triggeredEventReporters.size(); ++i) {
            ...
            const SystemEventTriggerIndex index(
                info.triggeredReportIndices[i] + s.getEventTriggerStartByStage(stage)
                + s.getEventTriggerStartByStage(getMySubsystemIndex(), stage));
            trigInfo[index] = triggeredEventReporters[i]->getTriggerInfo();
            trigInfo[index].setEventId(info.triggeredReportIds[i]);
        }
    }
    void calcTimeOfNextScheduledEventImpl(const State& s,
                                          Real& tNextEvent,
                                          Array_<EventId>& eventIds,
    ...
    void calcTimeOfNextScheduledReportImpl(const State& s,
                                           Real& tNextEvent,
                                           Array_<EventId>& eventIds,
                                           bool includeCurrentTime) const override {
    ...
    void handleEventsImpl(State& s,
        ...
        results.setExitStatus(shouldTerminate ? HandleEventsResults::ShouldTerminate
                                              : HandleEventsResults::Succeeded);
    }

    void
    reportEventsImpl(const State& s, Event::Cause cause, const Array_<EventId>& eventIds) const override {
        const CachedEventInfo& info = getCachedEventInfo(s);
...
const DefaultSystemSubsystem::Guts& DefaultSystemSubsystem::getGuts() const {
    return SimTK_DYNAMIC_CAST_DEBUG<const DefaultSystemSubsystem::Guts&>(getSubsystemGuts());
}

DefaultSystemSubsystem::Guts& DefaultSystemSubsystem::updGuts() {
    return SimTK_DYNAMIC_CAST_DEBUG<DefaultSystemSubsystem::Guts&>(updSubsystemGuts());
}
 ...
 */
void DefaultSystemSubsystem::findSubsystemEventIds(SubsystemIndex subsys,
                                                   const State& state,
    ...
    for (int i = 0; i < (int)allEvents.size(); ++i) {
        std::map<int, SubsystemIndex>::const_iterator p = info.eventOwnerMap.find(allEvents[i]);
