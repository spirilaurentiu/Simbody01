...
#        if defined(CALLBACK)
#        else
#            if ((_MSC_VER >= 800) || defined(_STDCALL_SUPPORTED) || defined(_M_MRX000) || defined(_M_IX86) \
                 || defined(_M_ALPHA) || defined(_M_PPC))                                                   \
                    && !defined(MIDL_PASS)                                                                  \
                || defined(__LCC__)
...
GLUTAPI void APIENTRY glutMainLoop();
...
GLUTAPI void APIENTRY glutPostRedisplay();
#if (GLUT_API_VERSION >= 4 || GLUT_XLIB_IMPLEMENTATION >= 11)
GLUTAPI void APIENTRY glutPostWindowRedisplay(int win);
#endif
GLUTAPI void APIENTRY glutSwapBuffers();
GLUTAPI int APIENTRY glutGetWindow();
GLUTAPI void APIENTRY glutSetWindow(int win);
GLUTAPI void APIENTRY glutSetWindowTitle(const char* title);
GLUTAPI void APIENTRY glutSetIconTitle(const char* title);
GLUTAPI void APIENTRY glutPositionWindow(int x, int y);
GLUTAPI void APIENTRY glutReshapeWindow(int width, int height);
GLUTAPI void APIENTRY glutPopWindow();
GLUTAPI void APIENTRY glutPushWindow();
GLUTAPI void APIENTRY glutIconifyWindow();
GLUTAPI void APIENTRY glutShowWindow();
GLUTAPI void APIENTRY glutHideWindow();
#if (GLUT_API_VERSION >= 3)
GLUTAPI void APIENTRY glutFullScreen();
...
GLUTAPI void APIENTRY glutEstablishOverlay();
GLUTAPI void APIENTRY glutRemoveOverlay();
GLUTAPI void APIENTRY glutUseLayer(GLenum layer);
GLUTAPI void APIENTRY glutPostOverlayRedisplay();
#    if (GLUT_API_VERSION >= 4 || GLUT_XLIB_IMPLEMENTATION >= 11)
GLUTAPI void APIENTRY glutPostWindowOverlayRedisplay(int win);
#    endif
GLUTAPI void APIENTRY glutShowOverlay();
GLUTAPI void APIENTRY glutHideOverlay();
#endif
...
GLUTAPI int APIENTRY glutGetMenu();
...
GLUTAPI void APIENTRY glutDisplayFunc(void(GLUTCALLBACK* func)());
...
GLUTAPI void APIENTRY glutIdleFunc(void(GLUTCALLBACK* func)());
...
GLUTAPI void APIENTRY glutOverlayDisplayFunc(void(GLUTCALLBACK* func)());
#        if (GLUT_API_VERSION >= 4 || GLUT_XLIB_IMPLEMENTATION >= 9)
...
GLUTAPI void APIENTRY glutJoystickFunc(void(GLUTCALLBACK* func)(unsigned int buttonMask, int x, int y, int z),
                                       int pollInterval);
#        endif
#    endif
#endif
...
#endif
#if (GLUT_API_VERSION >= 3)
GLUTAPI int APIENTRY glutGetModifiers();
...
GLUTAPI void APIENTRY glutWireDodecahedron();
GLUTAPI void APIENTRY glutSolidDodecahedron();
GLUTAPI void APIENTRY glutWireTeapot(GLdouble size);
GLUTAPI void APIENTRY glutSolidTeapot(GLdouble size);
GLUTAPI void APIENTRY glutWireOctahedron();
GLUTAPI void APIENTRY glutSolidOctahedron();
GLUTAPI void APIENTRY glutWireTetrahedron();
GLUTAPI void APIENTRY glutSolidTetrahedron();
GLUTAPI void APIENTRY glutWireIcosahedron();
GLUTAPI void APIENTRY glutSolidIcosahedron();

#if (GLUT_API_VERSION >= 4 || GLUT_XLIB_IMPLEMENTATION >= 9)
/* GLUT video resize sub-API. */
GLUTAPI int APIENTRY glutVideoResizeGet(GLenum param);
GLUTAPI void APIENTRY glutSetupVideoResizing();
GLUTAPI void APIENTRY glutStopVideoResizing();
...
GLUTAPI void APIENTRY glutReportErrors();
#endif
...
GLUTAPI void APIENTRY glutForceJoystickFunc();
...
GLUTAPI int APIENTRY glutEnterGameMode();
GLUTAPI void APIENTRY glutLeaveGameMode();
